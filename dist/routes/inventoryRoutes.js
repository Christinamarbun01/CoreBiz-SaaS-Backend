...
import { adjustInventorySchema, adjustInventory, getInventoryLogs, } from '../controllers/inventoryController.js';
const router = Router();
// ─── Auth Guard ──────────────────────────────────────────────────────────────
 ...
 */
router.post('/adjust', authorizeRole(['admin', 'owner', 'manager']), validateBody(adjustInventorySchema), adjustInventory);
/**
