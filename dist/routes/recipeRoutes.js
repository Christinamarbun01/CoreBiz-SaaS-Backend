...
import { recipeSchema, getRecipes, addRecipe, removeRecipe, } from '../controllers/recipeController.js';
 ...
 */
router.post('/', authorizeRole(['admin', 'owner', 'manager']), validateBody(recipeSchema), addRecipe);
/**
 * DELETE /api/v1/products/:id/recipes/:recipeId
 * Menghapus bahan baku dari resep produk.
 */
router.delete('/:recipeId', authorizeRole(['admin', 'owner', 'manager']), removeRecipe);
